...
//                       </div>
//                     ) : (
//                       <button onClick={() => handleReviewFormOpen(project.id)}>Add Review</button>
//                     )}
//                   </>
//                 )}
//               </div>
...
//   useEffect(() => {
//     fetch('/project_reviews') // Fetch associated reviews for completed projects
//       .then((response) => response.json())
//       .then((data) => {
...
//                 {current_user && current_user.role === 'client' && (
//                   <button onClick={() => handleReviewFormOpen(project.id)}>
//                     {projectReviews[project.id] ? 'Edit Review' : 'Add Review' : 'Delete Review' }
//                   </button>
//                 )}
//                 {showReviewForm && selectedProjectId === project.id && (
//                   <div className="rating-review-form">
