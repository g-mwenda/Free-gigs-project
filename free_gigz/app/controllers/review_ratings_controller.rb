class ReviewRatingsController < ApplicationController
     ...
     def index 
          ...
          render json: reviews, include: :freelancer
     end
     ...
     ###create a new review
     def create
       completed_project = CompletedProject.find(params[:completed_project])
     ...
     def review_rating_params
       params.permit(:client_id, :freelancer_id, :rating, :review)
     end
